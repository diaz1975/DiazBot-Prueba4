...
await conn.sendFile(m.chat, pp, 'lp.jpg', cat, fkontak, false, { contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' 🥷 Súper DiazBot-v3  - WhatsApp ', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb.getRandom()}}})
